...
class UriResolverTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testValidatesArray()
    {
        $this->expectExceptionMessage(
            "Invalid uri parameter value provided for \"foo\". Expected array, but got int(-1)"
        );
        $this->expectException(\InvalidArgumentException::class);
        $r = new UriResolver();
    ...
    {
        $this->expectExceptionMessage(
            "Invalid uri parameter value provided for \"foo\". Expected bool, but got int(-1)"
        );
        $this->expectException(\InvalidArgumentException::class);
        $r = new UriResolver();
    ...
    {
        $this->expectExceptionMessage(
            "Invalid uri parameter value provided for \"foo\". Expected callable, but got int(-1)"
        );
        $this->expectException(\InvalidArgumentException::class);
        $r = new UriResolver();
    ...
    {
        $this->expectExceptionMessage(
            "Invalid uri parameter value provided for \"foo\". Expected int, but got string(3)"
        );
        $this->expectException(\InvalidArgumentException::class);
        $r = new UriResolver();
    ...
    {
        $this->expectExceptionMessage(
            "Invalid uri parameter value provided for \"foo\". Expected string, but got int(-1)"
        );
        $this->expectException(\InvalidArgumentException::class);
        $r = new UriResolver();
